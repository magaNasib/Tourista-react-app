      ...
      <BackgroundBanner url={bgRoma}>
        ...
        <div className='flex flex-col w-[34rem] mx-auto text-center h-full justify-center items-center'>
          ...
          <div className='text-white my-8 flex gap-4 justify-center items-center'>
            ...
            <Link className='px-6 py-3 bg-[#4A21EF] rounded-[6.25rem]'>
              <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
                <path d="M4.1665 4.16667C4.1665 3.24619 4.9127 2.5 5.83317 2.5H14.1665C15.087 2.5 15.8332 3.24619 15.8332 4.16667V17.5L9.99984 14.5833L4.1665 17.5V4.16667Z" stroke="white" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
              </svg>
            </Link>
          </div>
        </div>
